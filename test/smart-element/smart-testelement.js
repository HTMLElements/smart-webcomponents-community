...
*/
Smart('smart-test-element-2', class TestElement2 extends Smart.BaseElement {
    ...
    static get properties() {
        return {
            ...
            'customValue': {
                value: 'a',
                type: 'string',
                allowedValues: ['a', 'b', 'v', 'invalid'],
                validator: '_customValueValidator',
                observer: '_customValueObserver'
            }
        };
    }
    ...
    */
    ...
    _customValueValidator(oldValue, value) {
        if (value === 'invalid') {
            return 'a';
        }
    ...
    _customValueObserver(oldValue, value) {
