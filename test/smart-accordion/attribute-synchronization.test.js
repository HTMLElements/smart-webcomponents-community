...
describe('Testing smartAccordion attributes-synchronization fixture', function () {
    ...
    jasmine.getFixtures().preload('smart-accordion-attributes-synchronization.htm');
    beforeEach(function () {
        loadFixtures('smart-accordion-attributes-synchronization.htm');
    ...
    var properties = [
        ...
        { name: 'expandedIndexes', value: [], type: 'array' },
